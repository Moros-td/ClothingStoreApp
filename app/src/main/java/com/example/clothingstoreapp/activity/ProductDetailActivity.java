...
import com.example.clothingstoreapp.fragment.fragmenOfBaseActivity.ProductDetailFragment;
...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            fragmentArgs.putSerializable("product", product);
        ...
        activityLauncher = registerForActivityResult(
                ...
                result -> {
                    if (result.getResultCode() == ResultCodeActivity.LOGIN_SUCCESS) {
                        //login thành công
                        Intent cartActivity = new Intent(ProductDetailActivity.this, CartBaseActivity.class);
    ...
    public void callApiSetCartCountItem(String token, String email) {
        Dialog dialog;
        dialog = openLoadingDialog(ProductDetailActivity.this);
        ApiService.apiService.checkItem(token, email).enqueue(new Callback<CheckItemResponse>() {
                ...
                if (response.isSuccessful()) {
                    ...
                    if(response.errorBody() != null) {
                        try {
                            ...
                            BaseActivity.openErrorDialog(ProductDetailActivity.this, errResponse.getErr());
                        } catch (IOException e) {
                            throw new RuntimeException(e);
                        }
                    }
                    else{
                        BaseActivity.openErrorDialog(ProductDetailActivity.this, "Lỗi");
                    }
                }
            }
            ...
            public void onFailure(Call<CheckItemResponse> call, Throwable throwable) {
                ...
                BaseActivity.openErrorDialog(ProductDetailActivity.this, "Không thể truy cập API, vui lòng thử lại sau!");
            }
